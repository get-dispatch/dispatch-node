...
module.exports = class Dispatch {
  constructor(apikey, env = "production", debug = false) {
    ...
    this.deliveries = {
       ...
       * @returns {Promise<Response>} Returns the response object. The data property [Responses's data property]{@link Delivery} will be the {@link Delivery} object.
       *
       ...
       *
       * @method list
       * @returns {Promise<Response>} Returns the response object. The data property [Responses's data property]{@link Delivery} will be an array of {@link Delivery} objects.
       *
       ...
       * @param {string} [sender.address_id] - If you have an address registered with dispatch, you can just send over the address_id instead of the full address
       * @param {(string|Object<NewAddress>)} [sender.address] - If you do not have an address_id, you can just send your address and we'll create one for you. Your address can just be a full string and we'll parse it on our end, or you can send it as an object
       ...
       * @param {string} [recipient.phone] - The phone number of this recipient that an on demand courier could use to contact this receipient if there is an issue
       ...
       * @param {string} [options.payment_methood] - The ID of the payment method you wish to use. We'll use the default card you have on file otherwise.
       * @returns {Promise<Response>} Returns the response object. The data property [Responses's data property]{@link Delivery} will be the {@link Delivery} object.
       *
       * @example
       *
       * //assuming we already created the delviery, we have access to the rates array, if any were returned
       ...
       *
       * //if the purchase was successful, the purchased rate will be avaible on the purchased_rate property
 ...
 * @property {Object} courier - The courier object if the delivery is on demand. This will be depricated in the future as the same data is found in the Provider object that is attached to the Rate.
 ...
 * @property {Object<Entity>} receipient - The recipient object. This is the person who is getting the package.
 ...
 * @property {Object<Entity>} sender - The object representing the sender, which is the entity that initally sent that package.
...
/**
 * The Entity object, whcih descripes a company or person
 ...
 * @property {Object} duration - descripes how long the delivery will take
 * @property {string} duration.arrives_by - the human readable string for the delivery date and time. For example: "Today by 9pm"
 * @property {integer} duration.days - the amount of days that this delivery is estimated to take
 * @property {(integer|null)} duration.pickup_at - epoch time in seconds when this order will be picked up
 * @property {(string|null)} duration.terms - this will be depricated in the future. Just use arrives_at
 * @property {Object} grace_period -The grace period that an on_demand courier will wait for and the fees for going over it.
 * @property {integer} grace_period.fee - The grace period fee as an integer.
 * @property {integer} grace_period.minutes - The amount of minutes that the grace period is good for.
 ...
 * @property {integer} invoice.additional_items_fee - The cost for additional items if the order contained multiple packages and the courier chaneges this fee
 ...
 * @property {integer} invoice.pickup_fee - The fixed pickuo fee that this courier charges
 ...
 * @property {integer} invoice.subtital - The total before taxes
 ...
 * @property {integer} pickup_at - @depricated epoch time in seconds when this order will be picked up. Same as duration.pickup_at
 ...
 * @param {string} NewAddress.zipcode - The zipcode. Technocally this is optional but highly recommended you add this because it makes the address parser much more accurate.
 */

/**
 * The Parcel Object. When you create a parcel or retreive a delivery, you'll always be referencing an array of parcels
 ...
 * @property {Array<Item>} [items] - you can optionally include items that are in the packages box. This can be used for on click returns in the future
 */
 ...
 * @property {string} [varient_id] - If this is a specific varient of a product id
