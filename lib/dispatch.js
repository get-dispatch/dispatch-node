...
module.exports = class Dispatch {
  constructor(apikey, env = "production", debug = false) {
    ...
    this.deliveries = {
       ...
       * @param {Integer} [options.checkout_total] - The total cart/checkout value you submitted as an integer (e.g., $15.76 would be represented as 1576). This value is used to determine the free shipping tier that you can set up on the Dispatch dashboard.
       * @returns {Promise<Response>} Returns the response object. The Response's [data property]{@link Delivery} will be an array of {@link Delivery} objects.
       *
       * @example
       * const sender = {
       ...
       * //if you don't want to pass additional options, just don't pass the fourth argument
       * const options = {
 ...
 * @property {string} label_url - The url from which you can download your label. This URL, can be accessed for 24 hours until it expires. Each time that you retrieve a delivery, a new label url is generated for you.
 ...
 * @param {string} address_line1 - The street address for this delivery.
 * @param {string} [address_line2] - The second line of the street address if needed.
 * @param {string} city - The name of the city.
 * @param {string} state - The state. This can be the full state name like California or an abbreviation like NY.
 * @param {string} zipcode - The zipcode. Technically this is optional but highly recommended you add this because it makes the address parser much more accurate.
 */
