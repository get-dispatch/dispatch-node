...
module.exports = class Dispatch {
  constructor(apikey, env = "production", debug = false) {
    ...
    this.deliveries = {
       ...
       *    //the delivery object have a lot of data and seting the pagination to a loop can really hurt performance
    ...
    //    * @returns {Promise<Response>} Returns the response object. The data property [Responses's data property]{@link Location} will be the {@link Location} object.
    //    *
 ...
 * @property {boolean} tracking_notificaitons - Indicates if dispatch will send update emails for the delivery. This value is set on your dashboard {@link https://app.getdispatch.app/settings/company/branding}
 ...
 * @property {Object} service_level - descripes how long the delivery will take
 ...
 * @property {integer} pickup_at - @depricated epoch time in seconds when this order will be picked up. Same as service_level.pickup_at
 ...
 * @property {(String|null)} address.address_line1 - The street address. Many carrier do not support this field and it can often be null
 ...
 * @property {(String|null)} comment - If the courier added a comment for this update
