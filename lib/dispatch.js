...
module.exports = class Dispatch {
  constructor(apikey, env = "production", debug = false) {
    ...
    this.deliveries = {
       ...
       * @param {string} [recipient.phone] - The phone number of this recipient that an on demand courier could use to contact this recipient if there is an issue._createDelivery.
